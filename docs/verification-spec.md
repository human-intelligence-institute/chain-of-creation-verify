...
empty input, below. A machine-readable copy of exactly these vectors is published beside
this page as **[`simhash64-vectors.json`](simhash64-vectors.json)** — fetch it rather than
